...
export default function AdminAnnouncementsPage() {
  ...
  return (
    <DashboardLayout title="Announcements" subtitle="Manage school-wide communications">
                      ...
                      <div className="flex items-start gap-3 flex-1">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="flex flex-wrap items-center gap-3 mt-1 text-xs text-slate-400 dark:text-slate-500 dark:text-slate-500">
                            ...
                            {ann.expires_at && <span className="flex items-center gap-1"><Clock size={12} />Expires: {new Date(ann.expires_at).toLocaleString()}</span>}
                          </div>
                        </div>
                      </div>
