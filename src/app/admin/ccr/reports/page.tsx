      ...
      <div className="space-y-3">
        {filtered.map(s => (
          <Link
            ...
            className="block bg-white rounded-xl border border-slate-200 p-4 hover:border-primary-300 transition-all"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-medium text-slate-800">{s.profile?.first_name} {s.profile?.last_name}</p>
                  <p className="text-sm text-slate-500">{s.class?.name} | {s.admission_number}</p>
                </div>
              </div>
