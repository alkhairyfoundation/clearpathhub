      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-900 dark:text-white dark:text-white">Skills Bank</h1>
              <p className="text-slate-500 dark:text-slate-400 dark:text-slate-400 mt-1">Define skills students can select for their growth journey</p>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="card text-center py-16">
            ...
            <p className="font-medium text-slate-500 dark:text-slate-400 dark:text-slate-400">No skills found</p>
            <p className="text-sm text-slate-400 dark:text-slate-500 dark:text-slate-500 mt-1 mb-4">{searchQuery ? 'Try a different search' : 'Create your first skill'}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredSkills.map((item) => (
              <div key={item.id} className={`card relative ${!item.is_active ? 'opacity-60' : ''}`}>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 dark:text-slate-400 line-clamp-2">{item.description}</p>
