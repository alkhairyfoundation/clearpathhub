    ...
    <DashboardLayout title="My Profile" subtitle="Manage your account settings">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 dark:text-slate-400 mt-1">Manage your account settings</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="card text-center">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 dark:text-slate-400 mt-1">Administrator</p>
          ...
          <div className="mt-6 space-y-2 text-left">
            <div className="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-400 dark:text-slate-400 p-2 rounded-lg bg-slate-50 dark:bg-slate-800 dark:bg-slate-800">
              <Mail size={16} className="text-slate-400 dark:text-slate-500 dark:text-slate-500 flex-shrink-0" />
              <span className="truncate">{profile.email}</span>
            </div>
            {profile.phone && (
              <div className="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-400 dark:text-slate-400 p-2 rounded-lg bg-slate-50 dark:bg-slate-800 dark:bg-slate-800">
                <Phone size={16} className="text-slate-400 dark:text-slate-500 dark:text-slate-500 flex-shrink-0" />
                <span>{profile.phone}</span>
              </div>
            )}
            <div className="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-400 dark:text-slate-400 p-2 rounded-lg bg-slate-50 dark:bg-slate-800 dark:bg-slate-800">
              <Calendar size={16} className="text-slate-400 dark:text-slate-500 dark:text-slate-500 flex-shrink-0" />
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Profile Info */}
          <div className="card">
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white dark:text-white mb-5 flex items-center gap-2">
              <User size={20} className="text-blue-600 dark:text-blue-400 dark:text-blue-400" />
              Personal Information
            </h2>

            {saved && (
              <div className="mb-4 p-3 bg-emerald-50 dark:bg-emerald-900/20 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-900/40 dark:border-emerald-900/40 rounded-lg text-emerald-700 dark:text-emerald-300 dark:text-emerald-300 text-sm flex items-center gap-2">
                <Check size={16} /> Profile updated successfully
              </div>
            )}
            {error && (
              <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/20 dark:bg-red-900/20 border border-red-200 dark:border-red-900/40 dark:border-red-900/40 rounded-lg text-red-700 dark:text-red-400 dark:text-red-400 text-sm flex items-center gap-2">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="email" value={formData.email} disabled className="input bg-slate-50 dark:bg-slate-800 dark:bg-slate-800 text-slate-500 dark:text-slate-400 dark:text-slate-400 cursor-not-allowed" />
          ...
          <div className="card">
            <h2 className="text-lg font-semibold text-slate-900 dark:text-white dark:text-white mb-5 flex items-center gap-2">
              <Shield size={20} className="text-blue-600 dark:text-blue-400 dark:text-blue-400" />
              Change Password
            </h2>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    minLength={6}
                  />
                  <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500 dark:text-slate-500 hover:text-slate-600 dark:text-slate-400 dark:text-slate-400">
          ...
          {schoolSettings && (
            <div className="card">
              <h2 className="text-lg font-semibold text-slate-900 dark:text-white dark:text-white mb-5 flex items-center gap-2">
                <MapPin size={20} className="text-blue-600 dark:text-blue-400 dark:text-blue-400" />
                School Information
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 dark:bg-blue-900/20 rounded-lg">
                  <p className="text-xs text-blue-600 dark:text-blue-400 dark:text-blue-400 font-medium mb-1">School Name</p>
                  <p className="font-semibold text-slate-900 dark:text-white dark:text-white">{schoolSettings.school_name || 'Not set'}</p>
                </div>
                <div className="p-4 bg-emerald-50 dark:bg-emerald-900/20 dark:bg-emerald-900/20 rounded-lg">
                  <p className="text-xs text-emerald-600 dark:text-emerald-400 dark:text-emerald-400 font-medium mb-1">Academic Year</p>
                  <p className="font-semibold text-slate-900 dark:text-white dark:text-white">{schoolSettings.academic_year || 'Not set'}</p>
                </div>
                <div className="p-4 bg-purple-50 dark:bg-purple-900/20 dark:bg-purple-900/20 rounded-lg">
                  <p className="text-xs text-purple-600 dark:text-purple-400 dark:text-purple-400 font-medium mb-1">Current Term</p>
                  <p className="font-semibold text-slate-900 dark:text-white dark:text-white">{schoolSettings.term || 'Not set'}</p>
                </div>
                <div className="p-4 bg-amber-50 dark:bg-amber-900/20 dark:bg-amber-900/20 rounded-lg">
                  <p className="text-xs text-amber-600 dark:text-amber-400 dark:text-amber-400 font-medium mb-1">Motto</p>
                  <p className="font-semibold text-slate-900 dark:text-white dark:text-white">{schoolSettings.school_motto || 'Not set'}</p>
                </div>
              </div>
