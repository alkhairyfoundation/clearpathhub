  ...
  return (
    <DashboardLayout title="Scan Student ID" subtitle="Scan QR code or enter admission number to mark attendance">
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Scan Student ID</h1>
          <p className="text-slate-500">Scan QR code or enter admission number to mark attendance</p>
        </div>
            ...
            {lastScanned ? (
              <div className="flex items-center gap-4 p-4 bg-green-50 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-slate-800">{lastScanned.profile?.first_name} {lastScanned.profile?.last_name}</p>
                  <p className="text-sm text-slate-500">{lastScanned.admission_number} &bull; {lastScanned.class?.name}</p>
                </div>
              </div>
            ) : (
