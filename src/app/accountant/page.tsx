      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { title: 'Total Income', value: formatCurrency(stats.income), icon: <TrendingUp size={24} />, href: '/accountant/transactions', bg: 'bg-green-100', color: 'text-green-600', trend: 'up' },
              { title: 'Total Expenses', value: formatCurrency(stats.expense), icon: <TrendingDown size={24} />, href: '/accountant/transactions', bg: 'bg-red-100', color: 'text-red-600', trend: 'down' },
          ...
          <div className="card">
            <h2 className="text-lg font-bold text-slate-900 mb-4 flex items-center gap-2"><BarChart3 size={18} className="text-slate-400" />Quick Actions</h2>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                { label: 'Transactions', href: '/accountant/transactions', icon: <DollarSign size={20} />, bg: 'bg-green-50 text-green-600' },
                { label: 'Invoices', href: '/accountant/invoices', icon: <FileText size={20} />, bg: 'bg-blue-50 text-blue-600' },
                { label: 'Receipts', href: '/accountant/receipts', icon: <Printer size={20} />, bg: 'bg-purple-50 text-purple-600' },
                { label: 'Reports', href: '/accountant/reports', icon: <BarChart3 size={20} />, bg: 'bg-amber-50 text-amber-600' },
              ].map((link, i) => (
