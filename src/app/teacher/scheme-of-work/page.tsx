    ...
    <DashboardLayout title="My Scheme of Work" subtitle="Plan your weekly curriculum">
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">My Scheme of Work</h1>
            <p className="text-slate-500 mt-1">Plan your weekly curriculum</p>
          </div>
        </div>
        ...
        {filters.term_id && filters.subject_id ? (
          <div className="card p-0 overflow-hidden">
            <div className="flex items-center justify-between p-4 border-b border-slate-200 bg-slate-50">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-slate-700">{weeks} Weeks</span>
                {selectedSubject?.class && (
                  <span className="text-sm text-slate-400">| {selectedSubject.class.name}</span>
                )}
              </div>
          ...
          <div className="card text-center py-16">
            ...
            <p className="font-medium text-slate-500">Select a term and subject</p>
            <p className="text-sm text-slate-400 mt-1">to view and edit your scheme of work</p>
          </div>
        )}
      </div>
    </DashboardLayout>
