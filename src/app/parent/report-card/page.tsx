...
function ReportCardContent() {
  ...
  const subjectGrades = results.reduce((acc: any[], r) => {
    ...
    if (!sub) {
      sub = { subjectId: r.subject_id, subjectName: r.subject?.name || 'Unknown', midterm: null as number | null, exam: null as number | null };
      acc.push(sub);
    }
    if (r.exam_type === 'ca1') sub.midterm = r.score;
